...
ActiveRecord::Schema.define(version: 20150608223035) do
  ...
  create_table "realm_types", force: :cascade do |t|
    t.string "title"
  end
  ...
  create_table "wow_patches", force: :cascade do |t|
    t.string "title"
    t.text   "description"
  end
